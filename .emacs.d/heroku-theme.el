...
(custom-theme-set-faces
 'heroku
 '(default (( t (:background "(0)" :foreground "#eeeeec")))) ;; terminal's background priority
; '(default (( t (:background "#000000" :foreground "#eeeeec"))))       ;; GUI frame
 ...
 ;; font lock
 ; =========================================================
 '(font-lock-builtin-face ((t (:foreground "#ccccff"))))
 ; =========================================================
 
 '(font-lock-comment-face ((t (:foreground "#aeaeae"))))
 
 '(font-lock-function-name-face ((t (:foreground "#f0cc1e"))))
 
 '(font-lock-keyword-face ((t (:foreground "#a663cc"))))
 ; =========================================================
 
 '(font-lock-string-face ((t (:foreground "#adc6ee"))))
 ; =========================================================
 
 '(font-lock-type-face ((t (:foreground"#9a9856"))))
 ; =========================================================
 
 '(font-lock-variable-name-face ((t (:foreground "#f0cc1e"))))
 ; =========================================================
