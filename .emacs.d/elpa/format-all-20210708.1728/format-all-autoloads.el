...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "format-all" '("fish-indent" "fprettify" "yapf" "v-fmt" "terraform-fmt" "scalafmt" "shfmt" "snakefmt" "sqlformat" "swiftformat" "rescript" "perltidy" "pgformatter" "prettier" "purty" "ocp-indent" "ormolu" "nix" "mix-format" "latexindent" "ledger-mode" "lua-fmt" "ktlint" "jsonnetfmt" "istyle-verilog" "hindent" "html-tidy" "gawk" "gleam" "elm-format" "emacs-" "define-format-all-formatter" "dartfmt" "dfmt" "dhall" "dockfmt" "cabal-fmt" "cmake-format" "crystal" "beautysh" "black" "brittany" "bsrefmt" "buildifier" "atsfmt" "auctex")))
